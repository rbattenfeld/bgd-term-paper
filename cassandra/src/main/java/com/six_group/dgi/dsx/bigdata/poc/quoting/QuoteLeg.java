...
public class QuoteLeg implements Serializable {
	...
	public static QuoteLeg getLeg(final String line, final SimpleDateFormat timeFormatter1, final SimpleDateFormat timeFormatter2) throws NumberFormatException, ParseException {
		return new QuoteLeg(
			    ...
			    getDateTime(line, timeFormatter1, timeFormatter2),
...
//		buf.append(getOrigdate());
	...
	private static Date getDateTime(final String line, final SimpleDateFormat timeFormatter1, final SimpleDateFormat timeFormatter2) throws ParseException {
		if (line.indexOf("AgreedDate") > 0) {
			return timeFormatter2.parse(ExtractValueUtil.INSTANCE.getValue(line, "AgreedDate", true) + " " + ExtractValueUtil.INSTANCE.getValue(line, "AgreedTime", true));
	    } else {
	    	return timeFormatter1.parse(ExtractValueUtil.INSTANCE.getValue(line, "Original Date", true) + " " + ExtractValueUtil.INSTANCE.getValue(line, "Original Time", true));
	    }
	}
}
